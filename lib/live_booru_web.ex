defmodule LiveBooruWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: LiveBooruWeb

      import Plug.Conn
      import LiveBooruWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/live_booru_web/templates",
        namespace: LiveBooruWeb
  ...
  defp view_helpers do
    quote do
      ...
      import LiveBooruWeb.ErrorHelpers
      import LiveBooruWeb.Gettext
      alias LiveBooruWeb.Router.Helpers, as: Routes
    end
  end
